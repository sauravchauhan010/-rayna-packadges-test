  ...
  export function renderHotels() {
    ...
    if (state.agentUnlocked) {
      ...
      ` : state.folderSheets.length === 0 ? `
        <div style="background:#fff;border-radius:8px;border:1px dashed #d5d0c8;overflow:hidden;">
          <div style="padding:10px 18px;border-bottom:1px dashed #d5d0c8;display:flex;align-items:center;gap:6px;flex-wrap:wrap;">
          ...
          <p style="text-align:center;padding:40px 20px;font-size:14px;color:#888;margin:0;">This folder is empty.</p>
        </div>
      ` : `
